...
\begin{longtable}{LR}
  ...
  2015  & A cross-linguistic study of the non-at-issueness of exhaustive
          ...
          Dordrecht. \doi{10.1007/978-3-319-07980-6_6}\\ % chktex 8
  %
  ...
  \node at ($({pic cs:p1}) +(-0.3,0.1)$) {\textdagger};
  \node at ($({pic cs:p2}) +(-0.3,0.1)$) {\textdagger};
  \node at ($({pic cs:p3}) +(-0.3,0.1)$) {\textdagger};
  \node at ($({pic cs:p4}) +(-0.3,0.1)$) {\textdagger};
  \end{tikzpicture}
\end{longtable}
