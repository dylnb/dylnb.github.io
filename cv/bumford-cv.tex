...
\usepackage[scaled]{garamondx} % defaults to lining figures, good for math
...
\begingroup
\renewcommand{\arraystretch}{1} % extra space between rows
\begin{longtable}{LR}
...
\begin{longtable}{@{}p{\textwidth}@{}}
  %
  Bumford, Dylan. Split-scope definites: Relative exclusives and
  Anti-uniqueness readings. In prep.\\
  %
  Champollion, Lucas, Dylan Bumford, \with~Robert Henderson. Homogeneity in
