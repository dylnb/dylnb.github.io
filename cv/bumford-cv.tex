...
\begin{longtable}{LR}
  ...
  2019  & Donkeys under discussion.\newline
          ...
          To appear in \textit{Semantics \& Pragmatics}.\\
  %
...
\begin{longtable}{LR}
  2019 & Invited colloquium, UC Irvine.\\
  %
  2019 & Invited colloquium, University of Arizona.\\
  %
...
\begin{longtable}{LR}
  ongoing & Co-chair, Emotive factives and \textit{whether}-questions, Maayan
            Abenina-Adar
            \\
  %
  ongoing & Member, Tense in nominals, Maura O'Leary
            \\
  %
  ongoing & Member, \textit{wh-} in situ sluicing in Minimalist Grammars,
            Deborah Wong
            \\
  %
  ongoing & Member, Title TBD, Richard Stockwell
            \\
\end{longtable}
...
\begin{longtable}{LR}
  ongoing & Member, Title TBD, Madeleine Booth
\end{longtable}
...
\textit{Synthese} (2018),
\textit{Semantics \& Pragmatics} (2012, 2017--2019),
...
\begin{longtable}{LR}
  2019--     & Merit Review Committee, UCLA Linguistics\\
