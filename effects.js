(() => {
  ...
  var applyFirst = function(dictApply) {
    ...
    return function(a3) {
      return function(b2) {
        return apply1(map25($$const)(a3))(b2);
      };
    };
  };
  var applySecond = function(dictApply) {
    ...
    return function(a3) {
      return function(b2) {
        return apply1(map25($$const(identity2))(a3))(b2);
      };
    };
  };
  ...
  var showOp = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at TDParseCFG (line 194, column 10 - line 208, column 30): " + [v.constructor.name]);
    }
  };
  var genericCat_ = {
    to: function(x2) {
  ...
  var semTerm = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at TDParseCFG (line 447, column 1 - line 447, column 23): " + [v.constructor.name]);
  };
  ...
  var commuteF = {
    commutative: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at TDParseCFG (line 233, column 17 - line 238, column 19): " + [v.constructor.name]);
    }
  };
  ...
  var norm = function(op1) {
    var startsWith = function(v) {
      return function(v1) {
        ...
        ;
        throw new Error("Failed pattern match at TDParseCFG (line 418, column 5 - line 418, column 37): " + [v.constructor.name, v1.constructor.name]);
      };
    };
    ...
    return function(v) {
      ...
      if (v instanceof J) {
        return !anyOf(function(v1) {
          ...
          var $1219 = commutative2(v.value0);
          if ($1219) {
  ...
  var opTerm = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at TDParseCFG (line 456, column 10 - line 497, column 74): " + [v.constructor.name]);
  };
  ...
  var addD = function(v) {
    ...
    if (v.value1.value1 instanceof Eff && v.value1.value1.value0 instanceof C) {
      var $1278 = eq3(v.value1.value1.value0.value1)(v.value1.value1.value1);
      if ($1278) {
        var $1279 = norm(v.value0)(D.value);
        if ($1279) {
  ...
  var addJ = function(v) {
    ...
    if (v.value1.value1 instanceof Eff && v.value1.value1.value1 instanceof Eff) {
      var $1308 = monad(v.value1.value1.value0);
      if ($1308) {
        var $1309 = norm(v.value0)(new J(v.value1.value1.value0));
        if ($1309) {
      ...
      return function(combine) {
        return function(v) {
          ...
          if (v1.value0 instanceof Arr && (v1.value0.value1 instanceof Arr && (v1.value1 instanceof Eff && v1.value1.value0 instanceof R))) {
            var $1373 = eq3(v1.value0.value1.value0)(v1.value1.value0.value0);
            if ($1373) {
              var $1374 = eq3(v1.value1.value1)(v1.value0.value0);
              if ($1374) {
          ...
          return function(bins) {
            return function(uns) {
              return curry(fix4(function() {
                var $1442 = memoizeTag2(tag);
                var $1443 = openCombine2(bins)(uns);
                return function($1444) {
                  return $1442(function(v) {
                    var $1445 = map32(handler);
                    return function($1446) {
                      return $1445(v($1446));
                    };
                  }($1443($1444)));
                };
    ...
    return function(bins) {
      return function(uns) {
        ...
        var go = function(v) {
          ...
          ;
          throw new Error("Failed pattern match at TDParseCFG (line 262, column 5 - line 262, column 63): " + [v.constructor.name]);
        };
        return function($1447) {
          return execute(go($1447));
        };
      };
    };
  };
  ...
  var indefLex = /* @__PURE__ */ function() {
    ...
    var ann = make_con("a");
    return map12(mkLex)(new Cons(new Tuple("some", pure8(new Tuple(Nothing.value, new Tuple(Det.value, new Arr(new Arr(E.value, T.value), effS(E.value)))))), new Cons(new Tuple("a", pure8(new Tuple(Nothing.value, new Tuple(Det.value, new Arr(new Arr(E.value, T.value), effS(E.value)))))), new Cons(new Tuple("someone", pure8(new Tuple(new Just(so3), new Tuple(DP.value, effS(E.value))))), new Cons(new Tuple("nobody", pure8(new Tuple(new Just(no), new Tuple(DP.value, new Arr(effS(new Arr(E.value, T.value)), T.value))))), new Cons(new Tuple("eclo", append(semigroupList)(pure8(new Tuple(new Just(eclo), new Tuple(Cmp.value, new Arr(effS(T.value), T.value)))))(pure8(new Tuple(new Just(eclo), new Tuple(Dmp.value, new Arr(effS(T.value), T.value)))))), Nil.value))))));
  }();
  ...
  var proLex = /* @__PURE__ */ function() {
    ...
    var eclo = make_con("\u2203");
    var ann = make_con("a");
    return map13(mkLex)(new Cons(new Tuple("she", pure9(new Tuple(new Just(idTerm), new Tuple(DP.value, effR(E.value)(E.value))))), new Cons(new Tuple("it", append5(pure9(new Tuple(new Just(idTerm), new Tuple(DP.value, effR(E.value)(E.value)))))(pure9(new Tuple(new Just(idTerm), new Tuple(DP.value, effR(effR(E.value)(E.value))(effR(E.value)(E.value))))))), new Cons(new Tuple("her", append5(pure9(new Tuple(new Just(idTerm), new Tuple(DP.value, effR(E.value)(E.value)))))(pure9(new Tuple(new Just(idTerm), new Tuple(Gen.value, effR(E.value)(E.value)))))), new Cons(new Tuple("__", append5(pure9(new Tuple(new Just(idTerm), new Tuple(DP.value, effR(E.value)(E.value)))))(pure9(new Tuple(new Just(idTerm), new Tuple(DP.value, effR(effR(E.value)(E.value))(effR(E.value)(E.value))))))), new Cons(new Tuple("who", pure9(new Tuple(new Just(idTerm), new Tuple(DP.value, effR(E.value)(E.value))))), new Cons(new Tuple(",", append5(pure9(new Tuple(new Just(top3), new Tuple(AV.value, new Arr(effR(effR(E.value)(E.value))(T.value), new Arr(effR(E.value)(E.value), T.value))))))(append5(pure9(new Tuple(new Just(top3), new Tuple(AV.value, new Arr(effR(E.value)(T.value), new Arr(E.value, T.value))))))(pure9(new Tuple(new Just(top3), new Tuple(AV.value, new Arr(effR(effR(E.value)(E.value))(effR(E.value)(T.value)), new Arr(effR(E.value)(E.value), effR(E.value)(T.value))))))))), new Cons(new Tuple(":", append5(pure9(new Tuple(new Just(top3), new Tuple(AV.value, new Arr(effR(E.value)(T.value), new Arr(E.value, T.value))))))(pure9(new Tuple(new Just(top3), new Tuple(AV.value, new Arr(effR(effR(E.value)(E.value))(T.value), new Arr(effR(E.value)(E.value), T.value))))))), Nil.value))))))));
  }();
  ...
  var pureLex = /* @__PURE__ */ function() {
    ...
    var eclo = make_con("\u2203");
    var ann = make_con("a");
    return map14(mkLex)(new Cons(new Tuple("ann", pure10(new Tuple(Nothing.value, new Tuple(DP.value, E.value)))), new Cons(new Tuple("mary", pure10(new Tuple(Nothing.value, new Tuple(DP.value, E.value)))), new Cons(new Tuple("'s", pure10(new Tuple(new Just(poss), new Tuple(GenD.value, new Arr(E.value, new Arr(new Arr(E.value, E.value), E.value)))))), new Cons(new Tuple("left", pure10(new Tuple(Nothing.value, new Tuple(VP.value, new Arr(E.value, T.value))))), new Cons(new Tuple("whistled", pure10(new Tuple(Nothing.value, new Tuple(VP.value, new Arr(E.value, T.value))))), new Cons(new Tuple("saw", pure10(new Tuple(Nothing.value, new Tuple(TV.value, new Arr(E.value, new Arr(E.value, T.value)))))), new Cons(new Tuple("saved", pure10(new Tuple(Nothing.value, new Tuple(TV.value, new Arr(E.value, new Arr(E.value, T.value)))))), new Cons(new Tuple("spent", pure10(new Tuple(Nothing.value, new Tuple(TV.value, new Arr(E.value, new Arr(E.value, T.value)))))), new Cons(new Tuple("chased", pure10(new Tuple(Nothing.value, new Tuple(TV.value, new Arr(E.value, new Arr(E.value, T.value)))))), new Cons(new Tuple("said", pure10(new Tuple(Nothing.value, new Tuple(AV.value, new Arr(T.value, new Arr(E.value, T.value)))))), new Cons(new Tuple("gave", pure10(new Tuple(Nothing.value, new Tuple(DV.value, new Arr(E.value, new Arr(E.value, new Arr(E.value, T.value))))))), new Cons(new Tuple("mom", pure10(new Tuple(Nothing.value, new Tuple(FN.value, new Arr(E.value, E.value))))), new Cons(new Tuple("paycheck", pure10(new Tuple(Nothing.value, new Tuple(FN.value, new Arr(E.value, E.value))))), new Cons(new Tuple("pictureof", pure10(new Tuple(Nothing.value, new Tuple(RN.value, new Arr(E.value, new Arr(E.value, E.value)))))), new Cons(new Tuple("the", pure10(new Tuple(Nothing.value, new Tuple(Det.value, new Arr(new Arr(E.value, T.value), E.value))))), new Cons(new Tuple("very", pure10(new Tuple(Nothing.value, new Tuple(Deg.value, new Arr(new Arr(E.value, T.value), new Arr(E.value, T.value)))))), new Cons(new Tuple("everyP", pure10(new Tuple(Nothing.value, new Tuple(Det.value, new Arr(new Arr(E.value, T.value), new Arr(new Arr(E.value, T.value), T.value)))))), new Cons(new Tuple("big", pure10(new Tuple(Nothing.value, new Tuple(AdjP.value, new Arr(E.value, T.value))))), new Cons(new Tuple("happy", pure10(new Tuple(Nothing.value, new Tuple(AdjP.value, new Arr(E.value, T.value))))), new Cons(new Tuple("dog", pure10(new Tuple(Nothing.value, new Tuple(NP.value, new Arr(E.value, T.value))))), new Cons(new Tuple("cat", pure10(new Tuple(Nothing.value, new Tuple(NP.value, new Arr(E.value, T.value))))), new Cons(new Tuple("near", pure10(new Tuple(Nothing.value, new Tuple(TAdj.value, new Arr(E.value, new Arr(E.value, T.value)))))), new Cons(new Tuple("and", pure10(new Tuple(Nothing.value, new Tuple(Cor.value, new Arr(T.value, new Arr(T.value, T.value)))))), new Cons(new Tuple("but", pure10(new Tuple(Nothing.value, new Tuple(Cor.value, new Arr(T.value, new Arr(T.value, T.value)))))), new Cons(new Tuple("if", pure10(new Tuple(Nothing.value, new Tuple(Adc.value, new Arr(T.value, new Arr(T.value, T.value)))))), new Cons(new Tuple("andE", pure10(new Tuple(Nothing.value, new Tuple(Cor.value, new Arr(E.value, new Arr(E.value, E.value)))))), new Cons(new Tuple("with", pure10(new Tuple(Nothing.value, new Tuple(TAdv.value, new Arr(E.value, new Arr(new Arr(E.value, T.value), new Arr(E.value, T.value))))))), Nil.value))))))))))))))))))))))))))));
  }();
      ...
      var go = function(v1) {
        ...
        if (v1 instanceof $$Set) {
          ...
          var getvar = function(v3) {
            ...
            ;
            throw new Error("Failed pattern match at TDPretty (line 131, column 13 - line 131, column 41): " + [v3.constructor.name]);
          };
        ...
        ;
        throw new Error("Failed pattern match at TDPretty (line 103, column 10 - line 161, column 29): " + [v1.constructor.name]);
      };
      return go(v);
    };
  };
      ...
      var displayF = function(b1) {
        return function(f) {
          return span4([class$prime2("constructor")])(function() {
            ...
            ;
            throw new Error("Failed pattern match at TDPretty (line 71, column 11 - line 76, column 31): " + [f.constructor.name]);
          }());
        };
      };
  ...
  var defCombs = /* @__PURE__ */ function() {
    return [MRComb.value, MLComb.value];
  }();
  ...
  var update = function(model) {
    return function(v) {
      ...
      if (v instanceof TypeInput) {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 129, column 5 - line 131, column 77): " + [v1.constructor.name]);
      }
      ;
      ...
      if (v instanceof AddLex && v.value0.value0 === "Enter") {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 142, column 5 - line 144, column 83): " + [v1.constructor.name]);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Main (line 119, column 16 - line 153, column 78): " + [v.constructor.name]);
    };
  };
  ...
  var view = function(model) {
    ...
    }))([new Tuple("pure", PureLex.value), new Tuple("pro", ProLex.value), new Tuple("indef", IndefLex.value)]))), div5([id("combsInventory"), class$prime3("opt-group")])(append15([text("Select combinators:")])(map111(addSwitch(CombChoice.create)(function(v) {
      return elem12(v)(defCombs);
    }))([new Tuple("R (map right)", MRComb.value), new Tuple("L (map left)", MLComb.value), new Tuple("UR (unit right)", URComb.value), new Tuple("UL (unit left)", ULComb.value), new Tuple("Z (binding)", ZComb.value), new Tuple("A (apply)", AComb.value)])))])])]);
  };
